...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <?php
                if(isset($_GET['mensaje']) and $_GET['mensaje']=='serv_falta'){
            ?>
            ...
            <?php
                if(isset($_GET['mensaje']) and $_GET['mensaje']=='serv_registrado'){
            ?>
            ...
            <?php
                if(isset($_GET['mensaje']) and $_GET['mensaje']=='serv_error'){
            ?>
            ...
            <?php
                if(isset($_GET['mensaje']) and $_GET['mensaje']=='serv_editado'){
            ?>
            ...
            <?php
                if(isset($_GET['mensaje']) and $_GET['mensaje']=='serv_eliminado'){
            ?>
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><a class="text-success" href="serv_editar.php?id=<?php echo $dato->id; ?>"><i class="bi bi-pencil-square"> Editar</i></a></td>
                                <td onclick="return confirm('¿Esta seguro de eliminar?')"><a class="text-danger" href="serv_eliminar.php?id=<?php echo $dato->id; ?>"><i class="bi bi-trash"> Eliminar</i></a></td>
                            </tr>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <form  class="p-4" method="POST" action="serv_registrar.php">
                    <div class="mb-3">
